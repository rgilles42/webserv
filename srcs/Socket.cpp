...
/*   Updated: 2021/11/22 15:24:35 by rgilles          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Socket::Socket(const char* addr, unsigned short port) : _fd(socket(AF_INET, SOCK_STREAM, 0))
{
	int					optval = 1;
